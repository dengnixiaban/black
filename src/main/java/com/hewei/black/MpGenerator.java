...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setBaseColumnList(false);// XML columListei
        gc.setAuthor("hewei");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/black?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=UTC");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setTablePrefix(new String[]{"nkd_dormitory_","nkd_student_", "sys_", "hw_"});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"hw_menu","hw_role_menu"}); // 需要生成的表
